...
type Endpoints interface{
	...
	GetByCrmId(idParam string) func(w http.ResponseWriter, r *http.Request)
}
...
func(ef *endpointsFactory) GetByCrmId(idParam string) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	paramid, paramerr := vars[idParam]
	if !paramerr {
	...
	obj, err := ef.Inter.GetByCrmId(id)
	if err != nil {
		respondJSON(w, http.StatusInternalServerError, &customError{
			"no object by id",
		})
