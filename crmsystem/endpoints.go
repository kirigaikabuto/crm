...
type Endpoints interface{
	...
	GetByClientId(idParam string) func(w http.ResponseWriter, r *http.Request)
}
...
func(ef *endpointsFactory) GetByClientId(idParam string) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		vars := mux.Vars(r)
		paramid, paramerr := vars[idParam]
		if !paramerr {
		...
		obj, err := ef.Inter.GetByClientId(id)
		if err != nil {
			respondJSON(w, http.StatusInternalServerError, &customError{
				"no object by id",
			})
